    ...
    return(
        ...
        <div className="h-[calc(100vh-60px)]">
            <div className="max-w-fit mx-auto mt-[35vh] flex flex-col relative z-10">
                <h1 className="text-mainPink font-[TT-Travels-Next-Light] mx-auto text-5xl mb-10 sm:text-4xl sm:mb-4">
                    The emperor of all databases.</h1>
                <h3 className="font-[TT-Autonomous-Mono-Reg] text-white mx-auto text-xl text-center sm:text-lg">
                    Find out for yourself why Charlemagne was voted as the most loved <br/> NoSQL database by developers in 2025.</h3>
