    ...
    return (
        ...
        <motion.div ref={terminalContainer} style={{ opacity }} className='min-h-[100vh] grid grid-cols-2 mx-auto ml-[calc(50vw-600px)] max-w-[1400px]'>
            <div className='pr-[75px]'>
                ...
                <p className='text-white text-2xl pt-[50px] font-[TT-Autonomous-Mono-Variable] inline max-w-[500px]'>The first databse to have generative AI prompting through the command line. We have an LLM to build schemas for you from the ground up, so you can spend less time doing and more time delivering.</p>
            </div>
