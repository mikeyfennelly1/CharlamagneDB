const ManageTheIPAccessList = () => {
    return (
        <>
            <div>
                <p>An IP is a unique numeric identifier for a device connecting to a network. In Loco, you can only connect to a cluster from a trusted IP address. Within Loco, you can create a list of trusted IP addresses, referred to as a IP access list, that can be used to connect to your cluster and access your data.</p>
                ...
                <h3>Procedure</h3>
                <p>Since you selected the Automate security setup checkbox when you created your first cluster, Loco automatically adds your IP address to the IP access list.</p>
