        ...
        <div className=" mb-[300px]">
            <div className="xl:grid xl:grid-cols-2 max-w-[1600px] mx-auto my-auto">
                ...
                <div className="2xl:pl-[50px] mb-5">
                    <div className="2xl:pl-[20px] pt-[50px] mb-5 scale-75 2xl:scale-100">
                ...
                <div className="my-auto font-[TT-Autonomous-Mono-Variable] text-left justify-start max-w-[700px] mr-auto 2xl:max-w-[800px] md:mx-auto mx-5 2xl:pl-[50px] ">
                    <h1 className='text-mainPink text-[1.9rem] font-[TT-Travels-Next-Med] pt-5 text-left mr-[100px] 2xl:mr-0'>Document model explained</h1>
                    <h3 className='text-white mt-[30px] text-[1.3rem] font-thin mr-[100px] 2xl:mr-0'>Discover a more flexible and intuitive way to handle your data with the CharlemagneDB document model. Store data in rich, nested structures for effortless organization and querying, all while experiencing top-notch performance and scalability. Ready to transform your data management? Learn more about the document model with CDB.</h3>
                </div>
            </div>
        </div>
        </>
