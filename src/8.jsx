    ...
    return (
        <>
            <div className="border-2 bg-white">
                <div className="min-h-[200px] mx-auto grid lg:grid-cols-2 max-w-[3000px] my-[100px]">

                    <div className="mx-[30px] lg:ml-[100px]">
                        <div className="text-black font-[TT-Travels-Next-Med] text-[2rem] lg:text-[3rem] my-[50px] mb-[150px]">
                    ...
                    <div className="grid pt-[50px] font-[TT-Autonomous-Mono-Reg] ml-[30px] grid-cols-2
                                    lg:max-w-[50%] lg:ml-auto lg:grid-cols-3">
                        <div className="border-black lg:ml-[200px]">
                            <ul>
