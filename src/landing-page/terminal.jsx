        ...
        <motion.div ref={terminalContainer} style={{ opacity }} className=' lg:mx-auto lg:max-w-[1600px] max-w-[90vw]'>
            <div className='border-2 border-mainPink max-h-fit max-w-[1600px] bg-gradient-to-b from-[#101] bg-opacity-20 
                ...
                <div className='relative py-[80px] lg:block text-[0.8rem] max-w-screen'>
                    <img src={constructUrl("../images/terminal3.png")} alt="" className='terminal max-w-screen lg:max-w-[700px] inline min-h-[300px] lg:min-h-[600px]'/>
                        <p className=' text-[0.5rem] sm:text-[1rem] font-[SourceCodePro-Medium] text-mainPink absolute top-[120px] sm:top-[150px] left-[20px] pr-[20px] sm:left-8 max-w-[700px] font-bold'>cdb prompt: <span className=' text-white'>"Create a schema in JS for my ecommerce store, so that I can track my customers' names, orders and locations."</span></p>
                            <p className='text-[0.5rem] sm:text-[1rem] response font-[SourceCodePro-Medium] text-[#00ff9d] absolute top-[180px] sm:top-[230px] left-[20px] pr-[20px] sm:left-8 cdb-more'></p>
                </div>
            </div>
